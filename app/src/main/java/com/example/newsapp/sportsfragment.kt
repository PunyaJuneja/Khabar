...
class sportsfragment: Fragment() , Newsitemclicked{
    ...
    lateinit var newsarrays   :ArrayList<News>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclierviewofgeneral: RecyclerView =requireView().findViewById(R.id.recyclierviewofsports)
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                if (searchtext.isNotEmpty()) {
                   newsarrays.forEach {
                    ...
                    tempArayList.clear()
                    tempArayList.addAll(newsarrays)
                    madapter.updateitems(newsarrays)
                }
                return false
